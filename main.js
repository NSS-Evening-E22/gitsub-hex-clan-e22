  ...
  for (const pinned of array) {
    ...
    `<div class="card" style="width: 18rem;">
      <div class="card-body">
        ...
        <div class="flexRow">
          <p class="card-link"><svg class="javaScript-color" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 18a6 6 0 1 0 0-12 6 6 0 0 0 0 12Z"></path></svg> JavaScript</p>
...
const createPinned = (event) => {
  ...
  var name = document.querySelector('#inputProjectBoardName');
